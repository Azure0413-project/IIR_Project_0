...
function show(data, prompt) {
    ...
    const foodInfo = [
        {
            lora_img: `data:image/png;base64,${data.image_1}`,
        ...
        {
            lora_img: `data:image/png;base64,${data.image_2}`,
        ...
        {
            lora_img: `data:image/png;base64,${data.image_3}`,
    ...
    foodInfo.forEach(recipe => {
        ...
        listItem.innerHTML = `
            ...
            <p>
               <span style="font-size: 0.75rem;">Diffusion output:</span><br>
...
// typing effect
function typeEffect(element, text, delay = 150, repeat = true) {
    let index = 0;
        ...
        if (index < text.length) {
            ...
            if (repeat) {
                setTimeout(() => {
                    ...
                    index = 0;
                    typingDone = false;
                    typeNextCharacter(); // Restart typing effect
