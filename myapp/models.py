...
class ChatRecord(models.Model):
    ...
    response_image_1 = models.BinaryField(null=True, blank=True)
    response_image_2 = models.BinaryField(null=True, blank=True)
    response_image_3 = models.BinaryField(null=True, blank=True)
