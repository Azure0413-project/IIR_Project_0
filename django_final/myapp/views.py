...
def get_data(request):
    if request.method == 'POST':
        try:
            ...
            new_prompt = "Certainly! If you’re craving ramen, here are some great options near you..."
            restaurant_name = ['白露拉麵', '菜良sara', 'Nani麺']
            food_name = ['Chick Ramen', 'Shoyu Ramen', 'Beef Ramen']
